...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2026 at 02:40 PM
...
CREATE TABLE `ai_scanned_docs` (
  ...
  `doc_type` enum('DTR','Leave Form','Payslip','Travel Order','Unknown') NOT NULL DEFAULT 'Unknown',
...
CREATE TABLE `audit_logs` (
  ...
  `module` enum('DTR','Leave','Payroll','Employee','T.O.','Auth','Schedule','Training','Tracking','Signatory','Other') NOT NULL DEFAULT 'Other',
...
(6, 'GEAMH-C001', 'Agrimano', 'Rheanbelle', 'C.', 'Administrative Aide III', '', 'Information Technology', 'Casual', NULL, '2002-05-30', 0, '', '', '', '', '', '0.00', '0', '', '', '', '', 1, '2026-04-24 03:45:20', '2026-04-24 05:43:08'),
...
(269, 'KPFH-C080', 'Abaredes', 'Malaya', 'A.', 'Nursing Attendant I', '', 'Nursing', 'Casual', NULL, NULL, 0, '', '', '', '', '', '0.00', '', '', '', '', '', 1, '2026-04-24 03:45:20', '2026-04-24 04:37:34'),
...
(365, 'GEAMH-999', 'Cadavid', 'Francine', 'Mendoza', '', '', '', 'Permanent', NULL, '2004-04-28', 0, '', 'Single', 'Ormoc City', '09270122876', 'francine@geamh.gov.ph', '0.00', '0', '', '', '', '', 1, '2026-04-28 01:15:19', '2026-04-28 01:15:54');
...
CREATE TABLE `leave_records` (
  ...
  `employee_name` varchar(150) NOT NULL,
  `department` varchar(100) DEFAULT NULL,
  `leave_type` enum('Vacation Leave','Sick Leave','Maternity Leave','Paternity Leave','Special Leave','Emergency Leave','Forced Leave','Study Leave','Rehabilitation Leave','Terminal Leave') NOT NULL DEFAULT 'Vacation Leave',
...
(5, 'Thea Villanueva', 'HR Clerk II', 'DTR Processor', 'Human Resources', 5, 1, '2026-04-22 08:15:22', '2026-04-22 08:15:22');
