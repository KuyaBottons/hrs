...
const modules = ['Auth','Employee','DTR','Leave','Payroll','T.O.','Schedule','Training','Tracking','Signatory','Other']
...
onMounted(async () => {
  loading.value = true
  try {
    const res  = await fetch('http://localhost/hrs/server/api/audit_logs.php?limit=500')
    ...
    <div class="toolbar">
      <div class="toolbar-left">
        <div class="search-wrap">
          <input v-model="search" class="search-input" placeholder="Search user, action, details..." />
        </div>
