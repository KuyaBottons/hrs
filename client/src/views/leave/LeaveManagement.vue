...
function deleteRec(id) {
  if (confirm('Delete this leave record?')) store.deleteRecord(id)
}
...
function statusClass(s) {
  const map = { Pending: 'badge-orange', Approved: 'badge-green', Disapproved: 'badge-red', Cancelled: 'badge-gray' }
  ...
  <div class="page">
    <div class="toolbar">
      <div class="toolbar-left">
        ...
        <AppSelect
          v-model="filterType"
          :options="[{ label: 'All Leave Types', value: '' }, ...store.leaveTypes.map(t => ({ label: t, value: t }))]"
      ...
      <table class="data-table">
        ...
        <tbody>
          <tr v-if="filtered.length === 0">
            <td colspan="10" class="empty-row">No leave records found.</td>
          </tr>
        ...
        <div class="modal-body">
          <div class="form-grid">
            ...
            <div class="form-group">
              ...
              <AppSelect v-model="form.leaveType" :options="store.leaveTypes" />
            </div>
            <div class="form-group">
