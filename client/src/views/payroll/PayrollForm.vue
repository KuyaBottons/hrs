...
function submit() {
  if (isEdit.value) store.updateRecord(Number(route.params.id), form.value)
    ...
    <div class="form-card">
      ...
      <form @submit.prevent="submit">
        ...
        <div class="form-actions">
          <button type="button" class="btn btn-secondary" @click="router.push('/payroll')">Cancel</button>
